...
:mod:`conversation_analyst.vision.nods` for the detector and its calibration.
...
from conversation_analyst.measures.base import PERSON_LEVEL, measure
from conversation_analyst.session import PERSONS
from conversation_analyst.vision.nods import LISTENING, SPEAKING, NodTrack
