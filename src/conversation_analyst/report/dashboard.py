...
def _topic_block(context: AnalysisContext) -> str:
    ...
    from conversation_analyst.semantics import describe_topics
...
def _nod_block(context: AnalysisContext) -> str:
    ...
    from conversation_analyst.vision.nods import LISTENING, OTHER, SPEAKING, length_histogram
...
<footer>
Generated by conversation_analyst. Every value in this report traces to a documented
