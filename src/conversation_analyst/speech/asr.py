...
from conversation_analyst.config import ASRConfig
from conversation_analyst.system import fit_asr_model
...
class Transcript:
    ...
    :class:`conversation_analyst.speech.vocabulary.Correction`. Kept on the transcript
    ...
    def word_tuples(self) -> dict[str, list[tuple[float, float, str]]]:
        """Shape expected by :func:`conversation_analyst.turns.build_ipus`."""
...
def transcribe(
    ...
    # came out wrong. See :mod:`conversation_analyst.speech.vocabulary`.
    from conversation_analyst.speech.vocabulary import Vocabulary
