...
:mod:`conversation_analyst.speech.voiceprint`.
...
def attribute_speakers(
    ...
    if shared_audio and cfg.voiceprint and audio is not None and sample_rate:
        from conversation_analyst.speech.voiceprint import speaker_log_odds
...
def _smooth_source(x: np.ndarray, frame_hz: float, cfg: AttributionConfig) -> np.ndarray:
    ...
    offsets. See :class:`conversation_analyst.config.AttributionConfig`.
    """
