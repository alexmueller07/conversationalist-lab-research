...
# CA_MODEL_DIR is the current name; CONVLAB_MODEL_DIR is honoured so that
# an environment configured for the old name keeps working.
DEFAULT_MODEL_DIR = Path(
    os.environ.get("CA_MODEL_DIR")
    or os.environ.get("CONVLAB_MODEL_DIR")
    or "models"
)

_USER_AGENT = "conversation-analyst/1.0 (+https://github.com/alexmueller07/conversation-analyst)"
