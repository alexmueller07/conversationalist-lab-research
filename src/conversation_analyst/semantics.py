...
from conversation_analyst.config import SemanticConfig
from conversation_analyst.lexicon import (
    ADVERBS,
    ARTICLES,
    AUXILIARY_VERBS,
    CONJUNCTIONS,
...
The threshold is argued for in :class:`conversation_analyst.config.SemanticConfig`, but an
