@echo off
rem Double-click this file to open Conversation Analyst.
rem
...
if not exist ".venv\Scripts\python.exe" (
    echo First run: setting up Conversation Analyst. This downloads about 1.6 GB and takes 15-30 minutes.
    echo.
    where py >nul 2>nul
    if errorlevel 1 (
        python -m venv .venv
...
start "" ".venv\Scripts\pythonw.exe" -m conversation_analyst.gui
